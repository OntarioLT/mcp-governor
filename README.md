...
MCP Governor 是 AI 工具的统一治理中枢，包含：

- **免费功能**：注入防护 + PII 脱敏 + 审计追溯 + REST/gRPC/MCP 多协议接入 + Admin UI 基础管理
- **商业增强功能**（需单独签署商业授权协议）：Admin UI 高级增强及 OIDC SSO · 企业版全场景DEMO示例 · Ed25519 审计签名 · 链路风险检测等
